...
# terraform-aws-iam-instance-role-policy-attachment
...
Instead pin to the release tag (e.g. `?ref=tags/x.y.z`) of one of our [latest releases](https://gitlab.com/guardianproject-ops/terraform-aws-iam-instance-role-policy-attachment/releases).



```hcl
module "instance_role_attachment" {
  source     = "git::https://gitlab.com/guardianproject-ops/terraform-aws-iam-instance-role-policy-attachment?ref=tags/0.1.0"
  name       = var.name
...
Like this project? Please give it a ★ on [GitLab](https://gitlab.com/guardianproject-ops/terraform-aws-iam-instance-role-policy-attachment)
...
- [terraform-aws-ssm-param-store-iam](https://gitlab.com/guardianproject-ops/terraform-aws-ssm-param-store-iam) - This is a terraform module that creates a IAM role and policy that allows an EC2 instance to fetch SSM params that begin with a prefix.
...
File an [issue](https://gitlab.com/guardianproject-ops/terraform-aws-iam-instance-role-policy-attachment/issues), send us an [email][email] or join us in the Matrix 'verse at [#guardianproject:matrix.org][matrix] or IRC at `#guardianproject` on Freenode.

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://gitlab.com/guardianproject-ops/terraform-aws-iam-instance-role-policy-attachment/issues) to report any bugs or file feature requests.
